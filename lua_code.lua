...
function fact(n)  -- isso é um comentário
   _variavel1223 = 1; -- teste de variável
   if n == 0 then -- isso é outro comentário
      return 20/2 -- alterado para testar divisão
   ...
   and      not      or        elseif     while    do        function
   end      for      else      if         then     return    local   nil
-- Tambem abaixo sao outros itens lexicos permitidos na linguagem:
